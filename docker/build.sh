...
HAPPY_REF="${HAPPY_REF:-9a4fd599dcd02ebb10831f621eb5f06ae11e8ca4}"   # pinned sokdak/happy main SHA; the bump automation rewrites only the SHA above, so keep this comment generic
