...
HAPPY_REF="${HAPPY_REF:-d3455020ce3deb1b702cd6eb610165232c71df5d}"   # pinned sokdak/happy feature/antigravity-vnext SHA (2026-07-11, antigravity Claude refresh + agy backend + GPT-5.6 picker)
