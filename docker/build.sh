...
HAPPY_REF="${HAPPY_REF:-5f7bf0887971d87c2cf102557b4724f91bba7ef6}"   # pinned sokdak/happy feature/antigravity-vnext SHA (2026-07-11, antigravity Claude refresh + agy backend + GPT-5.6 picker)
