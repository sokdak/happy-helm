...
HAPPY_REF="${HAPPY_REF:-bd4cbb59529adfe45bdfab6768d24cc9f140f13b}"   # pinned sokdak/happy main SHA; the bump automation rewrites only the SHA above, so keep this comment generic
