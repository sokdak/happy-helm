...
HAPPY_REF="${HAPPY_REF:-5c4c36f8b2bf4dedcccbab96d9a41cf50b33ad55}"   # pinned sokdak/happy main SHA; the bump automation rewrites only the SHA above, so keep this comment generic
