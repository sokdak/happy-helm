...
HAPPY_REF="${HAPPY_REF:-c2c45e9715126209fd76f12a68903b6dc517debb}"   # pinned sokdak/happy main SHA; the bump automation rewrites only the SHA above, so keep this comment generic
