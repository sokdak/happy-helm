...
HAPPY_REF="${HAPPY_REF:-8d1e52cd859f2a3cf277c49cc4d56314c977c17e}"   # pinned sokdak/happy feature/antigravity-vnext SHA (2026-07-11, antigravity Claude refresh + agy backend + GPT-5.6 picker)
