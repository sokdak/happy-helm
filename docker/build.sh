...
HAPPY_REF="${HAPPY_REF:-26dd4f5cedff3fad4cf64bc90241f3049b20cce2}"   # pinned sokdak/happy main SHA; the bump automation rewrites only the SHA above, so keep this comment generic
