...
HAPPY_REF="${HAPPY_REF:-50996254984cebcf37d5aeb8ff26edbb24779a08}"   # pinned sokdak/happy feature/antigravity-vnext SHA (2026-07-11, antigravity Claude refresh + agy backend + GPT-5.6 picker)
