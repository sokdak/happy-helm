...
HAPPY_REF="${HAPPY_REF:-091059bb5f925fbac1f85865d510eef56a9e1a49}"   # pinned sokdak/happy main SHA; the bump automation rewrites only the SHA above, so keep this comment generic
