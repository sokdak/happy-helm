...
HAPPY_REF="${HAPPY_REF:-906b0e107e68d1c953740171fa21af0f228fa8a3}"   # pinned sokdak/happy main SHA; the bump automation rewrites only the SHA above, so keep this comment generic
