...
HAPPY_REF="${HAPPY_REF:-0766e269c8d03795dbe9f5076a81a3a8f47b81d7}"   # pinned sokdak/happy main SHA; the bump automation rewrites only the SHA above, so keep this comment generic
