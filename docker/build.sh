...
HAPPY_REF="${HAPPY_REF:-0ec4bafef47df36ccec060b723e64016492fcb9a}"   # pinned sokdak/happy feature/antigravity-vnext SHA (2026-07-11, antigravity Claude refresh + agy backend + GPT-5.6 picker)
