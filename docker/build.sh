...
HAPPY_REF="${HAPPY_REF:-f28f087802130c886921aa95b379736899e1d92a}"   # pinned sokdak/happy feature/antigravity-vnext SHA (2026-07-11, antigravity Claude refresh + agy backend + GPT-5.6 picker)
