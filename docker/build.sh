...
HAPPY_REF="${HAPPY_REF:-0b8a708cf6077dec0f3fa0f979798f242816873d}"   # pinned sokdak/happy main SHA; the bump automation rewrites only the SHA above, so keep this comment generic
