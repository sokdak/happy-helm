...
HAPPY_REF="${HAPPY_REF:-efad809489decbff927b3aca0fad23af15769340}"   # pinned sokdak/happy feature/antigravity-vnext SHA (2026-07-11, antigravity Claude refresh + agy backend + GPT-5.6 picker)
