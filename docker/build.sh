...
HAPPY_REF="${HAPPY_REF:-d7ff3d7b52708eae3e4cc44dc0bd046ed995677c}"   # pinned sokdak/happy main SHA; the bump automation rewrites only the SHA above, so keep this comment generic
